...
<body>
<main>
	<form action="announcements-signupDB.php" method="POST">
		<?php
		if(isset($_GET['error'])){
  ...
  <div class="form-group ">
    <label for="designation" class="ml-3" style="text-align: center;">Designation:</label>
    <input type="designation" class="form-control ml-5" placeholder="Your designation" id="designation" name="designation" style="width: 50%;" required>
  </div>
